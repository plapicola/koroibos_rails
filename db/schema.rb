...
ActiveRecord::Schema.define(version: 2019_06_17_225842) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "event_medalists", force: :cascade do |t|
    t.bigint "olympian_id"
    t.bigint "event_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "medal"
    t.index ["event_id"], name: "index_event_medalists_on_event_id"
    t.index ["olympian_id"], name: "index_event_medalists_on_olympian_id"
  end
  ...
  add_foreign_key "event_medalists", "events"
  add_foreign_key "event_medalists", "olympians"
